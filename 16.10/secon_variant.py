...
Мы считаем, что кролики сначала размножаются, часть умирает от старости, потом подвергаются выеданию.
То есть, если к началу сезона у нас было K кроликов, то они размножатся K+x, а затем их будут есть (-RIP).
Новопоявившийся кролик начинает существовать только со следующего месяца, но при этом его могут съесть в
предыдущем. (остчёт со следующего месяца)
То есть, изначальный кролик даст потомство только на четвёртый сезон и его потомство может быть тут же съедено,
при условии, что А = 3.
